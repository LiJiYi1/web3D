<template>
  ...
  <el-card style="background-image:url('../../public/前端页面资源/bgc/bgcMain10.gif');min-width:220px;max-width: 220px;margin-top:45px;margin-right:2%;float:right;opacity:0.9;background-color:#363434;width:30%">
    <template #header><p>THREE.JS介绍</p></template>
    <img
      src="../../public/前端页面资源/THREEIcon1.jpg"
      style="width: 100%;opacity:0.5"
    />
  <el-card style="background-image:url('../../public/前端页面资源/bgc/bgcMain4.gif');max-width: 100%;background-color:#363434;" >
