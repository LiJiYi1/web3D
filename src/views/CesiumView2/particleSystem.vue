...
initCesium()
   const viewModel = {
    ...
    function applyGravity(p, dt) {
        ...
        p.velocity=new Cesium.Cartesian3(10,10,40)
...
viewer.scene.primitives.add(
        new Cesium.ParticleSystem({
            image: "../../../public/CesiumBasicSource/kebiParticle.jpg",
            ...
            modelMatrix: Cesium.Transforms.eastNorthUpToFixedFrame(Cesium.Cartesian3.fromDegrees(117.16, 32.71, 0)),
            ...
            emitter: new Cesium.CircleEmitter(40.0),
...
viewer.camera.setView({
    destination:Cesium.Cartesian3.fromDegrees(117.16, 32.71, 600)
})
})
function initCesium(){
