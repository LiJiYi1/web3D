...
m.fabric.uniforms.normalMap = Cesium.buildModuleUrl('../../../public/CesiumBasicSource/normalmap.png');
//使用自定义参数
...
const promise=Cesium.GeoJsonDataSource.load('../../../public/CesiumBasicSource/polygon.json', {
