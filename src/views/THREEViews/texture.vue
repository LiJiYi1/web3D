...
const texture=texLoader.load('../../public/初级篇学习资源/earth.jpg');
...
mesh1.position.x+=40;
//创建贴图
const texture2=new THREE.TextureLoader().load('../../public/初级篇学习资源/t010e231e27462fe93f.jpg')
...
scene.add(mesh2)
//创建贴图并赋值给材质
material2.map=new THREE.TextureLoader().load('../../public/初级篇学习资源/指南针.png')
...
//mesh3开始贴图
const texture3=new THREE.TextureLoader().load('../../public/初级篇学习资源/纹理3.jpg')
...
//创建贴图
const Sky=new THREE.TextureLoader().load('../../public/初级篇学习资源/全景2048.jpg')
