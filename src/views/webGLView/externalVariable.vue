...
float dis=distance(u_mouse,gl_FragCoord.xy);
//在距离鼠标100的范围内让他有一个重复的圆环效果
if(dis<100.0){
vec4 color=vec4(sin(dis/2.0),sin(dis/2.0),sin(dis/2.0),1.0);
gl_FragColor=mix(vec4(texture.rgb,sin(u_time)),color,0.5);
}
else{
