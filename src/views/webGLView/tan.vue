...
//创建一个旋转矩阵
mat2 Rotate=mat2(cos(u_time/4.0),sin(u_time/4.0),-sin(u_time/4.0),cos(u_time/4.0));
pos=Rotate*pos;
//根据tan函数画一个自行车轮形状
float tan=tan(atan(pos.y/pos.x)*4.0);
//取消颜色渐变
float color=step(0.1,tan)-step(0.8,tan);
if(distance(pos.xy,vec2(0.0))<0.5){
