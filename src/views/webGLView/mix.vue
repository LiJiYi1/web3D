...
//创建三个相交的圆
//第一个圆范围
float dis=distance(pos,vec2(0,0.2));
//第二个圆范围
float dis1=distance(pos,vec2(-0.2,-0.2));
if(dis<0.4){
...
//相交部分的颜色进行一个混合
if(max(distance(pos,vec2(-0.2,-0.2)),distance(pos,vec2(0.0,0.2)))<0.4){
gl_FragColor=mix(vec4(1.0,0.0,0.0,1.0),vec4(0.0,0.0,1.0,1.0),0.5);
}
}
`
//初始化着色器
