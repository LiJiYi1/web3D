<template>
  <div id="main">
    ...
    <div ref="slider" style="width: 20px;height:100%;position:fixed;left:50%;background-color:red"></div>
  </div>
</template>
...
viewer.scene.splitPosition = slider.value.offsetLeft / slider.value.parentElement.offsetWidth;
