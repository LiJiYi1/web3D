  ...
  <div id="container" ref="container">
    ...
    <div style="position:relative;">
      <div style="position: absolute;left: 0px;top: 0px;">
        <img src="../../public/粮仓资源/信息背景.png" alt="" style="width:400px;opacity: 1.0;">
      </div>
      ...
      <div style="position:absolute;left:290px;top:25px">
        <img src="../../public/粮仓资源/温度.png" alt="" style="width:50px;">
      </div>
      ...
      <div style="position:absolute;left:80px;top:85px;font-size:60px;color:#00ffff;vertical-align:middle">
        <img id="grainImg" src="../../public/粮仓资源/豆子/红豆.png" alt="" style="width:60px;">
      </div>
