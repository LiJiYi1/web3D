<template>
    <div class="menu">
    <RouterView style="position:fixed;top:60.1px;left:0%;"></RouterView>
  ...
  >
    ...
    <el-sub-menu index="5">
      <template #title><span>关于我的学习历程</span></template>
      
      <el-menu-item route="/LearningJourney" index="/LearningJourney">学习历程</el-menu-item>
