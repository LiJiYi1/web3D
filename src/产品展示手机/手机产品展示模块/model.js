...
const textureCube = new THREE.CubeTextureLoader()
    .setPath('../../../public/手机产品展示资源/cube/MilkyWay/')
    .load(['dark-s_px.jpg', 'dark-s_nx.jpg', 'dark-s_py.jpg', 'dark-s_ny.jpg', 'dark-s_pz.jpg', 'dark-s_nz.jpg']);
const textureLoader=new THREE.TextureLoader()
loader.load('../../../public/手机产品展示资源/model/手机 copy.glb',(gltf)=>{
const baseTexture = textureLoader.load('../../../public/手机产品展示资源/model/basecolor.png')
const metalnessTexture = textureLoader.load('../../../public/手机产品展示资源/model/metallic.png')
const roughnessTexture = textureLoader.load('../../../public/手机产品展示资源/model/roughness.png')
const normalTexture = textureLoader.load('../../../public/手机产品展示资源/model/normal.png')
const alphaTexture = textureLoader.load('../../../public/手机产品展示资源/model/opacity.png')
...
model.add(gltf.scene)
    ...
    //创建一个纹理
    const map = textureLoader.load('../../../public/手机产品展示资源/光点.png')
    //创建一个精灵对象
...
fontLoader.load('../../../public/手机产品展示资源/fonts/gentilis_bold.typeface.json',(font)=>{
    // console.log(font);
